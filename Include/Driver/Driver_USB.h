...
/* USB Role */
#define USB_ROLE_NONE               (0U)
#define USB_ROLE_HOST               (1U)
#define USB_ROLE_DEVICE             (2U)

/* USB Pins */
#define USB_PIN_DP                  (1U << 0) ///< USB D+ pin
#define USB_PIN_DM                  (1U << 1) ///< USB D- pin
#define USB_PIN_VBUS                (1U << 2) ///< USB VBUS pin
#define USB_PIN_OC                  (1U << 3) ///< USB OverCurrent pin
#define USB_PIN_ID                  (1U << 4) ///< USB ID pin

/* USB Speed */
#define USB_SPEED_LOW               (0U)      ///< Low-speed USB
#define USB_SPEED_FULL              (1U)      ///< Full-speed USB
#define USB_SPEED_HIGH              (2U)      ///< High-speed USB
...
/* USB Endpoint Type */
#define USB_ENDPOINT_CONTROL        (0U)     ///< Control Endpoint
#define USB_ENDPOINT_ISOCHRONOUS    (1U)     ///< Isochronous Endpoint
#define USB_ENDPOINT_BULK           (2U)     ///< Bulk Endpoint
#define USB_ENDPOINT_INTERRUPT      (3U)     ///< Interrupt Endpoint
