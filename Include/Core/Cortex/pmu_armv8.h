...
__STATIC_INLINE void PMU_Enable(void);
__STATIC_INLINE void PMU_Disable(void);

__STATIC_INLINE void PMU_Set_EVTYPER(uint32_t num, uint32_t type);

__STATIC_INLINE void PMU_CYCCNT_Reset(void);
__STATIC_INLINE void PMU_EVCNTR_ALL_Reset(void);

__STATIC_INLINE void PMU_CNTR_Enable(uint32_t mask);
__STATIC_INLINE void PMU_CNTR_Disable(uint32_t mask);

__STATIC_INLINE uint32_t PMU_Get_CCNTR(void);
__STATIC_INLINE uint32_t PMU_Get_EVCNTR(uint32_t num);

__STATIC_INLINE uint32_t PMU_Get_CNTR_OVS(void);
__STATIC_INLINE void PMU_Set_CNTR_OVS(uint32_t mask);

__STATIC_INLINE void PMU_Set_CNTR_IRQ_Enable(uint32_t mask);
__STATIC_INLINE void PMU_Set_CNTR_IRQ_Disable(uint32_t mask);

__STATIC_INLINE void PMU_CNTR_Increment(uint32_t mask);
