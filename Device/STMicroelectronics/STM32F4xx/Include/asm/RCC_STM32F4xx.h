...
#define RCC_PERIPH_CCMDATARAM   ((uint64_t)(RCC_AHB1ENR_CCMDATARAMEN | RCC_PERIPH_AHB1_MASK))
...
#define RCC_PERIPH_FMC          ((uint64_t)(RCC_AHB3ENR_FSMCEN | RCC_PERIPH_AHB3_MASK))
#endif
...
#define RCC_PERIPH_SDIO         ((uint64_t)(RCC_APB2ENR_SDIOEN   | RCC_PERIPH_APB2_MASK))
