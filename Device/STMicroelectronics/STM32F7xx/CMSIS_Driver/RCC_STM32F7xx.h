...
#define RCC_PERIPH_AHB2_MASK            (0xFFFFFF0C)
#define RCC_PERIPH_AHB3_MASK            (0xFFFFFFFC)
#define RCC_PERIPH_APB1_MASK            (0x00001000)
#define RCC_PERIPH_APB2_MASK            (0x9308804C)
...
typedef enum {
  ...
  RCC_PERIPH_GPIOJ     = (int32_t)(RCC_AHB1ENR_GPIOJEN     | RCC_PERIPH_AHB1_MASK),
  RCC_PERIPH_GPIOK     = (int32_t)(RCC_AHB1ENR_GPIOKEN     | RCC_PERIPH_AHB1_MASK),
  ...
  RCC_PERIPH_DTCMRAM   = (int32_t)(RCC_AHB1ENR_DTCMRAMEN   | RCC_PERIPH_AHB1_MASK),
  ...
  RCC_PERIPH_DCMI      = (int32_t)(RCC_AHB2ENR_DCMIEN      | RCC_PERIPH_AHB2_MASK),
    ...
    defined(STM32F779xx)
  RCC_PERIPH_JPEG      = (int32_t)(RCC_AHB2ENR_JPEGEN      | RCC_PERIPH_AHB2_MASK),
#endif
  ...
  /* AHB3 */
  RCC_PERIPH_FMC       = (int32_t)(RCC_AHB3ENR_FMCEN       | RCC_PERIPH_AHB3_MASK),
  RCC_PERIPH_QSPI      = (int32_t)(RCC_AHB3ENR_QSPIEN      | RCC_PERIPH_AHB3_MASK),
  ...
  RCC_PERIPH_LPTIM1    = (int32_t)(RCC_APB1ENR_LPTIM1EN    | RCC_PERIPH_APB1_MASK),
  RCC_PERIPH_RTC       = (int32_t)(RCC_APB1ENR_RTCEN       | RCC_PERIPH_APB1_MASK),
  RCC_PERIPH_WWDG      = (int32_t)(RCC_APB1ENR_WWDGEN      | RCC_PERIPH_APB1_MASK),
  RCC_PERIPH_CAN3      = (int32_t)(RCC_APB1ENR_CAN3EN      | RCC_PERIPH_APB1_MASK),
  ...
  RCC_PERIPH_SPDIFRX   = (int32_t)(RCC_APB1ENR_SPDIFRXEN   | RCC_PERIPH_APB1_MASK),
  ...
  RCC_PERIPH_I2C4      = (int32_t)(RCC_APB1ENR_I2C4EN      | RCC_PERIPH_APB1_MASK),
  ...
  RCC_PERIPH_CEC       = (int32_t)(RCC_APB1ENR_CECEN       | RCC_PERIPH_APB1_MASK),
  ...
  RCC_PERIPH_SDMMC2    = (int32_t)(RCC_APB2ENR_SDMMC2EN    | RCC_PERIPH_APB2_MASK),
  ...
  RCC_PERIPH_SDMMC1    = (int32_t)(RCC_APB2ENR_SDMMC1EN    | RCC_PERIPH_APB2_MASK),
  ...
  RCC_PERIPH_SAI2      = (int32_t)(RCC_APB2ENR_SAI2EN      | RCC_PERIPH_APB2_MASK),
  ...
  RCC_PERIPH_DSI       = (int32_t)(RCC_APB2ENR_DSIEN       | RCC_PERIPH_APB2_MASK),
#endif
  RCC_PERIPH_DFSDM1    = (int32_t)(RCC_APB2ENR_DFSDM1EN    | RCC_PERIPH_APB2_MASK),
  RCC_PERIPH_MDIO      = (int32_t)(RCC_APB2ENR_MDIOEN      | RCC_PERIPH_APB2_MASK),
} RCC_Periph_t;
