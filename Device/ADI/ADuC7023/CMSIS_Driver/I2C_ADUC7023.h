...
#define I2C_INIT            ((uint16_t)0x0001)  // I2C initialized
#define I2C_POWER           ((uint16_t)0x0002)  // I2C powered on
#define I2C_SETUP           ((uint16_t)0x0004)  // I2C Master configured, clock set
